/*!
 * \file CDiscAdjHarmonicDriver.hpp
 * \brief Headers of the main subroutines for driving harmonic balance discrete adjoint problems.
 *        The subroutines and functions are in the <i>CDiscAdjHarmonicDriver.cpp</i> file.
 * \author 
...
/*!
 * \class CDiscAdjHarmonicDriver
 * \brief Class for driving single-zone harmonic balance adjoint solvers.
 * \author M. Sanchez
 * \version 7.3.0 "Blackbird"
 */

class CDiscAdjHarmonicDriver : public CSinglezoneDriver {
protected:
...
public:
  ...
  /*!
    ...
    */
  CDiscAdjHarmonicDriver(char* confFile,
  ...
  /*!
    ...
    */
  ~CDiscAdjHarmonicDriver(void) override;
   ...
   */
  void SetHarmonicBalance(unsigned short iInst);
  ...
  passivedouble GetFrequency_Sensitivity(unsigned short iInst) const;
};
